...
You will notice that we are only going to be using 14 of the 21 *feature* variables from the data set. These were chosen based off of personal interest in exploring their relationship to the diabetes response.
