...
This concept is exactly what we will be going to do, as you can head to our [Model Fitting](docs/Modeling.html) site to see how we used our EDA to build several different models.
